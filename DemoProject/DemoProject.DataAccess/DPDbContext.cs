...
namespace DemoProject.DataAccess
{
    public class DPDbContext : DbContext
    {
        ...
        public virtual DbSet<RolePagePermissionMapping> RolePagePermissionMapping { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(x => x.PagePermissionID);
            ...
            modelBuilder.Entity<RolePagePermissionMapping>(entity =>
            {
                entity.HasKey(x => x.RolePagePermissionMappingID);
                entity.ToTable("RolePagePermissionMapping");
            });
